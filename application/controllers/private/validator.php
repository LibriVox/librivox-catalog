...
class Validator extends Private_Controller {
    ...
    function update_metadata()
    {
    	...
    	unset($post['project_id']); unset($post['file_name']); unset($post['original_file']);
    ...
    function update_files()
    {
    	...
    	unset($post['project_id']);unset($post['action']);
    ...
    function delete_file()
    {
        ...
        unset($post['project_id']);unset($post['file_name']);
    ...
    function test_get_file()
    {
        ...
        //var_dump($section); return;
            ...
            if (!$file_name) { echo  'No file name'; return; }
