...
$lang['project_launch_template_type_of_proof'] = 'Niveau d\'écoute requis (Note: veuillez lire la [url=https://forum.librivox.org/viewtopic.php?f=21&t=17680]PL FAQ[/url] (en anglais)):';
...
$lang['project_launch_template_please_check_send_recording'] = 'Si cela ne fonctionne pas ou si vous avez des questions, veuillez consulter cette page du wiki: [url=https://wiki.librivox.org/index.php/How_to_Send_Your_Recording]How To Send Your Recording wiki page[/url] (en anglais).';
...
$lang['project_launch_template_proof_listeners'] = 'Aux auditeurs potentiels : Veuillez lire la [url=https://forum.librivox.org/viewtopic.php?f=21&t=17680]FAQ dans le forum [i]Listeners Wanted[/url] ~-(en anglais)-~ avant d\'écouter! Niveau d’écoute requis:';
...
$lang['project_launch_template_useful_link'] = 'Si c\'est votre premier enregistrement, vous trouverez ceci utile: [url]https://wiki.librivox.org/index.php/Guide_pour_les_d%E9butants[/url]';
...
$lang['project_launch_template_noise_cleaning_software'] = 'Écoutez votre fichier avec des écouteurs. Si vous entendez un bruit de fond, il est souhaitable de le réduire ou le supprimer en utilisant la dernière version du logiciel Audacity. Rendez-vous sur [url=https://wiki.librivox.org/index.php/Comment_éliminer_le_bruit_de_fond]cette page[/url] du wiki de LibriVox pour un guide complet.';
$lang['project_launch_template_id3_tags_learn_more'] = '(Pour en savoir plus, consultez notre page wiki ~(en anglais)~ : https://wiki.librivox.org/index.php/What_is_ID3)';
