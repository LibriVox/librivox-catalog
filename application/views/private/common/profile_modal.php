            ...
            <input type="hidden" id="user_id" name="user_id">
             ...
             <div class="control-group">
                 <div class="controls ">
                        ...
                        <input type="text" class="no-margin span3" name="username" id="username">
                        </label>
                 </div>
             </div>
             ...
             <div class="control-group">
                 <div class="controls ">
                        <label for="website"><span class="span2" ><span class="red" style="margin-right:4px;">&nbsp;</span>Website</span>
             ...
             <div class="control-group">
                 <div class="controls ">
                        <label for="password"><span class="span2" ><span class="red" style="margin-right:4px;">&nbsp;</span>Password</span>
             ...
             <div class="control-group">
                 <div class="controls ">
                        <label for="confirm_password"><span class="span2" ><span class="red" style="margin-right:4px;">&nbsp;</span>Confirm Password</span>
             ...
             <div id="groups_block">
                ...
                <p id="groups_label" style="margin-left: 40px;"><strong>Roles:</strong></p>

                <?php foreach ($roles as $role): ?>
                 <div class="control-group">
                     <div class="controls ">
                            <label for="groups"><span class="span2" ><span class="red" style="margin-right:8px;">&nbsp;</span><?= $role['label'];?></span>
                            <input type="checkbox" class="group_box" name="groups[]" id="groups_<?= $role['value'];?>" value="<?= $role['value'];?>" <?= $role['checked'] ? 'checked' : ''; ?> <?= $role['disabled'] ? 'disabled' : '' ?>>
                            </label>
                     </div>
                 </div> 
                <?php endforeach; ?> 
