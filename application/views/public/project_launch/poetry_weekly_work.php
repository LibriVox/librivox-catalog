...
<?= lang('project_launch_template_each_week_poem_chosen')?>

<?= sprintf(lang('project_launch_template_this_week_poem'), $link_to_text)?>
...
<?= lang('project_launch_template_album_title')?> <?= lang('project_launch_template_librivox_weekly_poem')?> 
...
<?= lang('project_launch_template_suggest_poem_weekly')?> 
